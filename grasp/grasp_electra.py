from transformers import ElectraPreTrainedModel, ElectraModel, AutoTokenizer, AutoConfig, PretrainedConfig
...
model = PointerRubricModel.from_pretrained('deepset/gelectra-large')
...
model.save_pretrained("./grasp-el-3")
tokenizer.save_pretrained("./grasp-el-3")