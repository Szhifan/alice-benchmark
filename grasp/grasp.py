...
dataset = read_dataset("alice_data/ALICE_train_new.csv")  # needs to contain rubrics, question, answer, label
...
conf = PointerRubricConfig.from_pretrained('deepset/gbert-large')
conf.layer_norm_eps = 1e-12
conf.position_embedding_type = "absolute"
conf._name_or_path = 'deepset/gbert-large'
